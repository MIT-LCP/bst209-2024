...
K-nearest neighbors (kNN) is another clustering algorithm. With kNN, for any point for which we want to predict a class, we look for the $k$ nearest points and then take an average of these points. 
