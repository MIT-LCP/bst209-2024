...
Now our tree is more complicated! We can see a few vertical boundaries as well as the horizontal one from before (and it makes sense we see this, given we know our modelling decisions are **greedy**. Some of these we may like, but some appear unnatural. Let's look at the tree itself.
