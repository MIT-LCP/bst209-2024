...
It does this by iteratively evaluating every feature (in our case, age and apachescore) at every possible split (46, 47, 48..). The approach is referred to as "greedy" because we are choosing the optimal split given our current state. 
