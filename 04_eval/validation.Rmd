...
When creating our training and test sets, we needed to be careful to avoid data leaks. The same applies when creating training and validation sets. We can use a `workflow` to help manage this issue.
...
set.seed(1)
cv <- vfold_cv(train_set, v = 5, repeats = 3, strata = actualhospitalmortality)
