...
t1 <- CreateTableOne(vars = names(cohort), data = cohort, factorVars = "actualhospitalmortality", strata = "actualhospitalmortality")
...
B) Which variables appear noticeably different in the "Alive" (0) and "Deceased" (1) groups? Hint: Check the tableone documentation with `help()`
