...
C) Table 2 reports performance in a series of benchmark tasks. The legend discusses "zero-shot prompting"; "5-shot prompting"; and "CoT". What is prompting? How would you describe these differnet approaches?
...
3) Describe the symptoms of a heart attack in men. Describe the symptoms of a heart attack in women. Compare the responses and discuss any observed differences.

4) What are the most common side effects of the flu vaccine? Compare results across the class.

5) Explain diabetes in simple terms for a patient.
